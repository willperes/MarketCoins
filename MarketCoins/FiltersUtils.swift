...
//  MarketCoins
//
//  Created by Willian Peres on 24/11/23.
//
...
enum OrderByFilterEnum: String, CaseIterable {
    ...
    var title: String {
        switch self {
        case .marketCapAsc, .marketCapDesc: return "Capitalização de Mercado"
        case .volumeAsc, .volumeDesc: return "Volume"
        }
    }

    var order: String {
        switch self {
        case .marketCapAsc, .volumeAsc: return "\u{2193}"
        case .marketCapDesc, .volumeDesc: return "\u{2191}"
        }
    }
}
